...
import { formatDefaultDate, formatterTableEmpty, formatterTablePrice, formatterTableWithSuffix, getSelectData, selectDictLabels } from './utils'
...
app.config.globalProperties.$formatterTablePrice = formatterTablePrice
